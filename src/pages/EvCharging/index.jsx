      ...
      <footer className="footer">
        <div className="footer-card">
          ...
          <button
            ...
            type="button"
            onClick={() => onAction({ title: "Reserve EV charging", description: "Leave your email to save a request for a charging slot near you.", buttonLabel: "Reserve a slot", type: "ev-charging" })}
          >
            Book Charging Slot
          </button>
        </div>
